...
def test_swap():
    ...
    # A board to check vertical swap
    ans_board1, _ = construct_board()
    ...
    ans_board1.children = [
        ans_board1.children[3],
        ans_board1.children[2],
        ans_board1.children[1],
        ans_board1.children[0]
    ]
    ...
    board.swap(1)
    assert equal_boards(board, ans_board1)
    board.swap(1)
    assert equal_boards(board, ref_board)
